...
export default memo(function Controls() {
  ...
  const currentMediaIndex =
    currentMedia && currentPlaylistIdArray.indexOf(currentMedia.id);
            ...
            >
              ...
              <Hide below="sm">
                ...
                <Flex gap="10px" alignItems="center">
                  ...
                  />
                  <MediaController songURL={songURL} setSongURL={setSongURL} />
                </Flex>
              </Hide>
            </Flex>
          </Flex>
